...
\title{From Clerks to Agentic AI: How Will Technology Transform the Labor Market in Finance?}
...
\section{I. How Does Agentic AI Impact Financial Markets?}
...
\section{II. Historical Lessons from the Computerization and Indexing Eras}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{../analysis/AI_exposure_analysis/figures/workforce_transformation.png}
  \caption{Workforce transformation cost comparison}
\end{figure}

\section{III. How Does Automation Raise Labor Productivity?}
...
\section{IV. How Do We Define Productivity and Automation Intensity?}
\subsection{A. Who Do We Study?}
...
Firm-years are assigned to the three broad technology eras using calendar-year cutoffs: \texttt{Computerization} (\texttt{1985-2000}), \texttt{Index investing} (\texttt{2000-2015}), and \texttt{AI / automation} (\texttt{2015-present}). These cutoffs are stylized, but they provide a transparent way to compare broad phases of technological change in finance.

\subsection{B. What Is the Productivity Measure?}
...
\subsection{C. How Is Task Automation Intensity Measured Across Eras?}
...
In the current AI-focused panel, the exposure measure counts direct AI language such as ``artificial intelligence,'' ``machine learning,'' ``generative AI,'' and ``autonomous agent,'' together with adjacent automation language such as ``automation,'' ``robotic process automation,'' and ``workflow automation.'' Direct AI terms receive higher weight, and the weighted count is normalized by total filing words to form the final \texttt{ai\_exposure} variable.

More generally, each era-specific score is normalized by filing length, and the scores can be standardized within sample for comparability. If useful for the broader paper, the three measures can also be combined into one composite \texttt{task\_automation\_intensity} index.

\section{V. Our Empirical Framework}
...
\begin{equation}
\log(1 + \text{outcome}_{it}) = \beta \cdot \text{ai\_exposure}_{it} + \text{firm FE} + \text{year FE} + \text{error}_{it}.
\end{equation}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{../analysis/simple_analysis/figures/simple_finance_productivity_eras_real.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{../analysis/simple_analysis/figures/wage_trends_by_group_real.png}
  \caption{Wage trends by group real}
\end{figure}

\subsection{D. Heterogeneity}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{../analysis/AI_exposure_analysis/figures/ai_exposure_event_study.png}
  \caption{Event-study style AI exposure dynamics}
\end{figure}

\section{VII. Transformation for the Financial Labor Market}
...
\section{VIII. What Are the Study's Limitations?}
...
\newblock Schumpeter Lecture, European Economic Association.
...
Brynjolfsson, E. 2022.
\newblock ``The Turing Trap: The Promise and Peril of Human-Like Artificial Intelligence.''
\newblock \emph{Daedalus}.
...
\newblock \emph{Foreign Affairs}, July/August.
...
\bibitem{kulveit2026postagi}
Kulveit, J. 2026.
\newblock ``Post-AGI Economics As If Nothing Ever Happens.''
\newblock \emph{LessWrong}, February 4, 2026.
\newblock \url{https://www.lesswrong.com/posts/fL7g3fuMQLssbHd6Y/post-agi-economics-as-if-nothing-ever-happens\#}
