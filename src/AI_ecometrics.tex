...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{workforce_transformation.png}
...
\begin{table}[H]
  ...
  \begin{tabular}{@{}>{\raggedright\arraybackslash}p{0.22\linewidth} >{\raggedright\arraybackslash}p{0.22\linewidth} >{\raggedright\arraybackslash}p{0.22\linewidth} >{\raggedright\arraybackslash}p{0.22\linewidth}@{}}
    \toprule
    \textbf{Cost component} & \textbf{U.S. Worker} & \textbf{Off-Shore Worker} & \textbf{AI Agent} \\
    \midrule
    ...
    \textbf{Per-call cost} & \textbf{\$4.80/call} & \textbf{\$0.88/call} & \textbf{\$0.83/call} \\
    \textbf{\shortstack{Annual\\(12.5k calls)}} & \textbf{\$60,000} & \textbf{\$11,000} & \textbf{\$10,375} \\
    \bottomrule
  \end{tabular}
\end{table}
